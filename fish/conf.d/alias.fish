...
alias hxel="hx ~/.config/espanso/match/_code.yml"
alias hxel="hx ~/.config/espanso/match/markdown/_latex.yml"
alias hxeo="hx ~/.config/espanso/match/markdown/_obsidian.yml"
