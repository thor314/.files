...
alias bu=echo "$@" >> ~/.setup/unsorted.sh
...
alias ctop="cointop"
function copyzk # copy my notes, replace a formatting issue
  cp ~/note/n-pazk* ~/zk
  s="^%%.*noteTextColor.*"
  f=$(rg -l $s ~/zk)
...
alias gsa=git submodule add https://github.com/thor314/$1 $1
...
alias hxco="hx ~/.setup/clones/helix/book/src/commands.md"
...
alias v='hx'
alias va='hx ~/.config/alacritty/alacritty.yml'
alias vb='hx ~/.setup/unsorted.sh'
alias vbi='hx ~/.setup/install.sh'
alias vbu='hx ~/.setup/install.sh'
alias vcg='hx ~/.cargo/cargo-generate.toml'
alias vd='hx ~/.files/install.conf.yaml'
alias vdp='hx ~/.files/private/install.conf.yaml'
alias vds='hx ~/.files/root/install.conf.yaml'
alias vdr='hx ~/.files/root/install.conf.yaml'
alias veb="hx ~/.config/espanso/match/base.yml"
alias vec="hx ~/.config/espanso/match/code.yml"
alias vel="hx ~/.config/espanso/match/latex.yml"
alias vem="hx ~/.config/espanso/match/mermaid.yml"
alias veo="hx ~/.config/espanso/match/obsidian.yml"
alias vet="hx ~/.config/espanso/match/thor.yml"
alias vj='hx ~/.config/zellij/config.yaml'
alias vo='hx ~/note/.obsidian.vimrc'
# OMZ: vsc+ vscode
alias vtmpl='hx ~/r/tmpl/base/Cargo.toml'
alias vv='hx ~/.vimrc'
alias vz='hx ~/.zsh.d/.zshrc'
alias vza='hx ~/.zsh.d/alias.sh'
